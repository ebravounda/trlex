...
import { Users, Settings, LogOut, Menu, X, ClipboardList, FileText, Mail, Building2, ListTodo, UserCog, Inbox, DollarSign, CalendarCheck, FileSpreadsheet, MessageCircle, FileDown, Monitor } from 'lucide-react';
...
const navItems = [
  ...
  { to: '/admin/servidor', label: 'Servidor', icon: Monitor },
